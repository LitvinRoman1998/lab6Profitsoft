...
public class ContractHibernateDaoTest {
    ...
    public void readTest() {
        ...
        ContractHibernateDao contractHibernateDao =new ContractHibernateDao();
        contractHibernateDao.create(contract1);
        contract2= contractHibernateDao.read(contract1.getId());
