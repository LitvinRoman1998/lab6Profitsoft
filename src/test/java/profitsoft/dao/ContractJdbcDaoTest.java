...
public class ContractJdbcDaoTest {
    @Test
    public void readTest() {
        ...
        ContractJdbcDao contractJdbcDao =new ContractJdbcDao();
        contractJdbcDao.create(contract1);
        contract2= contractJdbcDao.read(ContractJdbcDao.lastInsertedContract);
